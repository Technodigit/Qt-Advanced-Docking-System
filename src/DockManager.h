...
public:
	...
	enum eConfigFlag
	{
		...
		DisableTabbing = 0x4000000, //! If the flag is set, the user won't be able to drop dock widgets within existing dock area, only the outer dock areas are available
